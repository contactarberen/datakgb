<?php require APPROOT . '/views/inc/header.php'; ?>
    <a href="<?php echo URLROOT; ?>/contacts" class="btn btn-light"><i class="fa fa-backward"></i> Retour</a>
  
    <div class="card card-body bg-light mt-5">
        <h2>Modification d'un contact</h2>
        <p>Modification d'un contact à l'aide de ce formulaire</p>
        <form action="<?php echo URLROOT; ?>/contacts/edit/<?php echo $data['idContact']; ?>" method="post">
