<?php require APPROOT . '/views/inc/header.php'; ?>
    ...
    <div class="card card-body bg-light mt-5">
        <h2>Modification d'une ligne sur la mission</h2>
        <p>Modification d'une ligne sur la mission à l'aide de ce formulaire</p>
        <form action="<?php echo URLROOT; ?>/lignemissions/edit/<?php echo $data['idMission']; ?>" method="post">
