<?php require APPROOT . '/views/inc/header.php'; ?>
  ...
  <div class="card card-body bg-light mt-5">
    <h2>Modification d'une mission</h2>
    <p>Modification d'une mission à l'aide de ce formulaire</p>
    <form action="<?php echo URLROOT; ?>/missions/edit/<?php echo $data['idMission']; ?>" method="post">
